...
public class Iedex extends JWindow implements Runnable{

	paint pt;
	public static void main(String[] args) {
		// TODO Auto-generated method stub
		Iedex iedex = new Iedex();
		Thread t = new Thread(iedex);
		t.start();
...
class paint extends JPanel implements Runnable
{
	...
	public void paintComponent(Graphics g)
	{
		...
		if(tt>=23&&tt<29)
		{
			...
			if(tt>=29)
				for(int rr=23;rr<23;rr++)
				{
					g.drawString(shi[rr], 30, rr*20);
				}
		}
		if(tt>=29)
		{
